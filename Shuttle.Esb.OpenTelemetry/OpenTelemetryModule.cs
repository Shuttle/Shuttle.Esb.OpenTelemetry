...
namespace Shuttle.Esb.OpenTelemetry
{
    public class OpenTelemetryModule : IDisposable, IPipelineObserver<OnStarted>
    {
        ...
        public OpenTelemetryModule(IOptions<ServiceBusOpenTelemetryOptions> openTelemetryOptions, IOptions<ServiceBusOptions> serviceBusOptions, TracerProvider tracerProvider, IPipelineFactory pipelineFactory, IHostEnvironment hostEnvironment, IHostApplicationLifetime hostApplicationLifetime)
        {
